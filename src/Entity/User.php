...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToMany(targetEntity: Evenements::class)]
    ...
    public function addParticiper(Evenements $participer): static
    {
    ...
    public function removeParticiper(Evenements $participer): static
    {
